...
function paese() {
    ...
    const countryCodes1 = [
        4, 8, 10, 12, 16, 20, 24, 28, 32, 36, 40, 44, 48, 50, 51, 756, 760, 762, 929, 930, 931, 932, 933, 934, 935, 936, 937, 938, 939, 940, 941, 942, 943, 944, 945, 946, 947, 948, 949, 950, 951, 952, 953, 954, 955, 956, 957, 958, 959, 960, 961, 962, 963, 964, 965, 966, 967, 968, 969, 970, 971, 972, 973, 974, 975, 976, 977, 978, 979, 980, 981, 982, 983, 984, 985, 986, 987, 988, 989, 990, 991, 992, 993, 994, 995, 996, 997, 998, 999
    ];
    const countryCodes2 = [64, 68, 70, 72, 74, 76, 84, 86, 96, 100, 104, 108, 112, 116, 120, 124, 126, 132, 136, 140, 144, 148, 152, 156, 162, 166, 170, 174, 175, 178, 180, 184, 188, 191, 192, 196, 203, 204, 208, 212, 214, 218, 222, 226, 231, 232, 233, 234, 238, 239, 242, 246, 250, 254, 258, 260, 262, 266, 270, 275, 276, 288, 292, 296, 300, 304, 308, 312, 316, 320, 324, 328, 332, 334, 336, 340, 344, 348, 352, 356, 360, 364, 368, 372, 376, 380, 388, 392, 398, 400, 404, 408, 410, 414, 417, 418, 422, 426, 428, 430, 434, 438, 440, 442, 446, 450, 454, 458, 462, 466, 470, 474, 478, 480, 484, 492, 496];
    const countryCodes3= [ 52, 56, 60, 498, 499, 500, 504, 508, 512, 516, 520, 524, 528, 540, 554, 558, 562, 566, 570, 574, 580, 578, 580, 583, 584, 585, 586, 591, 598, 600, 604, 608, 612, 616, 620, 624, 630, 634, 638, 642, 643, 646, 652, 654, 659, 662, 663, 666, 670, 674, 678, 682, 686, 688, 690, 694, 702, 703, 704, 705, 706, 710, 724, 732, 736, 740, 744, 748, 752];
    const countryCodes4=[764, 768, 772, 776, 780, 784, 788, 792, 795, 796, 800, 804, 807, 818, 826, 831, 832, 833, 834, 835, 836, 840, 850, 854, 858, 860, 862, 876, 882, 887, 888, 891, 894, 896, 900, 901, 902, 903, 904, 905, 906, 907, 908, 910, 911, 912, 913, 914, 915, 916, 917, 918, 919, 920, 921, 922, 923, 924, 925, 926, 927, 928] ;
    const everCountry = [
        countryCodes1,
        countryCodes2,
        countryCodes3,
    ...
    const v = Math.floor(Math.random() * everCountry[c].length)+1;
    console.log("c: "+c+" v: "+v+" numero: "+everCountry[c][v])
    return everCountry[c][v];
}
...
function perdita(){
     ...
     if(win && win>score){
        ...
        localStorage.setItem('winC', score)
